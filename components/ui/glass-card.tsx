...
// ✅ Static card data (moved from ../../lib/utils)
const cardData = [
  {
    id: 1,
    title: "AI-Powered Design",
    description: "Experience the future of design powered by generative AI and automation.",
    color: "rgba(14, 165, 233, 0.8)", // sky blue
  },
  {
    id: 2,
    title: "Web3 Integration",
    description: "Seamlessly integrate blockchain experiences into modern web apps.",
    color: "rgba(168, 85, 247, 0.8)", // purple
  },
  {
    id: 3,
    title: "Next.js Performance",
    description: "Optimized rendering and server-side power for dynamic, scalable apps.",
    color: "rgba(34, 197, 94, 0.8)", // green
  },
  {
    id: 4,
    title: "Creative Motion",
    description: "Bring interfaces to life with GSAP and smooth scroll-based animations.",
    color: "rgba(239, 68, 68, 0.8)", // red
  },
  {
    id: 5,
    title: "Tailwind UI Magic",
    description: "Build elegant and consistent designs effortlessly using Tailwind CSS.",
